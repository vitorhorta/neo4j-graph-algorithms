 ...
 */
public class HugeWeightedPageRank extends Algorithm<HugeWeightedPageRank> implements PageRankAlgorithm {
     ...
     * {@link #HugeWeightedPageRank(ExecutorService, int, int, AllocationTracker, HugeIdMapping, HugeNodeIterator, HugeRelationshipIterator, HugeDegrees, double)}
     */
    HugeWeightedPageRank(
     ...
     */
    @Override
    public HugeWeightedPageRank compute(int iterations) {
        assert iterations >= 1;
        initializeSteps();
    ...
    @Override
    public HugeWeightedPageRank withLog(final Log log) {
        super.withLog(log);
        this.log = log;
        return this;
    }
    ...
    @Override
    public HugeWeightedPageRank me() {
        return this;
    }

    @Override
    public HugeWeightedPageRank release() {
