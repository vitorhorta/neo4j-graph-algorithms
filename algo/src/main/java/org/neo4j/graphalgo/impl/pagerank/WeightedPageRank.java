 ...
 */
public class WeightedPageRank extends Algorithm<WeightedPageRank> implements PageRankAlgorithm {

    private final ComputeSteps computeSteps;

    /**
     * Forces sequential use. If you want parallelism, prefer
     * {@link #WeightedPageRank(ExecutorService, int, int, IdMapping, NodeIterator, RelationshipIterator, Degrees, double)}
     */
    WeightedPageRank(Graph graph,
     ...
     */
    @Override
    public WeightedPageRank compute(int iterations) {
        assert iterations >= 1;
    ...
    @Override
    public WeightedPageRank me() {
        return this;
    }

    @Override
    public WeightedPageRank release() {
