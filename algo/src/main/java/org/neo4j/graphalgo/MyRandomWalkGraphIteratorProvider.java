...
public class MyRandomWalkGraphIteratorProvider<V> implements GraphWalkIteratorProvider<V> {
    ...
    public MyRandomWalkGraphIteratorProvider(IGraph<V, ?> graph, int walkLength, int numberOfWalks) {
        this(graph, walkLength, System.currentTimeMillis(), NoEdgeHandling.EXCEPTION_ON_DISCONNECTED,numberOfWalks);
    }
