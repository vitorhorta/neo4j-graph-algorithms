...
public class DeepWalkProc {
    ...
    @Procedure(value = "algo.deepWalk2", mode = Mode.WRITE)
    ...
    @Procedure(name = "algo.deepWalk2.stream", mode = Mode.READ)
    @Description("CALL algo.deepWalk2.stream(label:String, relationship:String, {graph: 'heavy/cypher', walkLength:10, vectorSize:10, windowSize:2, learningRate:0.01 concurrency:4, direction:'BOTH'}) " +
