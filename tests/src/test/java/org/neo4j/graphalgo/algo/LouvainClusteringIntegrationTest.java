...
public class LouvainClusteringIntegrationTest {
    ...
    public void shouldAllowCypherGraph() {
        final String cypher = "CALL algo.louvain('MATCH (n) RETURN id(n) as id', 'MATCH (s)-->(t) RETURN id(s) as source, id(t) as target', {graph:'cypher', weightProperty:'bla', defaultValue:1.0}) YIELD nodes, communityCount";
